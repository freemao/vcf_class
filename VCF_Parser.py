...
Abase, genotype attributes because these items in different vcf files at
the same positons. Caveat: the raw vcf file from samtools may not contain
the last colum which include genotype info, so you should filter those
lines firstly, then use this class.'''
